...
class LoginPage(MainGUI):
    def __init__(self, root, main):
        ...
        self.label.grid(row=1, column=0, pady=PADY, padx=PADX, sticky="n")
        self.username_entry.grid(row=2, column=0, pady=(0, PADY), padx=PADX, sticky="n")
        self.password_entry.grid(row=3, column=0, pady=(0, PADY), padx=PADX, sticky="n")
        self.remember_me_checkbox.grid(row=4, column=0, pady=(0, PADY), padx=PADX, sticky="n")
        self.login_button.grid(row=5, column=0, pady=(0, PADY), padx=PADX, sticky="n")
        self.sign_up_button.grid(row=6, column=0, pady=(0, PADY), padx=PADX, sticky="n")
